    ...
    public class DefaultSampleValueSchemaFilter : ISchemaFilter
    {
        ...
        private IOpenApiAny? GetPropertySampleValue(Type propertyInfoType, DefaultValueAttribute? defaultAttribute = null)
        {
            ...
            switch (propertyInfoType.Name)
            {
                ...
                case nameof(System.Double): exampleValue = new OpenApiInteger(GetDefaultValue(defaultAttribute, RandomizerHelper.GetRandomInt(1, 10))); break;
                case nameof(System.Boolean): exampleValue = new OpenApiBoolean(RandomizerHelper.GetRandomBoolean()); break;
                case nameof(System.String): exampleValue = new OpenApiString(GetDefaultValue(defaultAttribute, RandomizerHelper.GetRandomName())); break;
                case nameof(System.DateTime): exampleValue = new OpenApiString(DateTime.Now.ToUniversalTime().ToString("s")); break;
                //case nameof(System.DateTime): exampleValue = new OpenApiString(DateTime.Now.ToString("MM-dd-yyyy HH:mm:ss")); break;
